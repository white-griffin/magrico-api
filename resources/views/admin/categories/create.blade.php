                    ...
                    <div class="card-body pt-0 mt-2">
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <!--end::Label-->
                                <select class="form-control  form-select form-select-solid" id="parent_category" name="parent_category"></select>
