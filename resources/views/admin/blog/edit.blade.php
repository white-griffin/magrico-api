...
@section('content')
    <div id="kt_content_container" class="container-xxl">
        <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework"
              action="{{route('admin.blogs.update',$blog)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!--begin::Main column-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        @include('admin.__components.select-2-ajax', [
                                            ...
                                            'selectedItems' => (isset($blog->category_id))? [
                                                ['id' => $blog->category_id,'title'=> $blog->category->title]
                                                ] : null
                                            ])
                                        <!--end::Input-->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        @include('admin.__components.input-text', [ 'name' => 'slug','value' => $blog->slug])
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
